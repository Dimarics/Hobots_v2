...
T.ComboBox {
    ...
    /*delegate: Q.Item {
        ...
        required property var model
        required property int index
        width: popup.width//Q.ListView.view.width //height: root.height
        height: 30
        Q.Rectangle {
        ...
        Q.MouseArea {
            anchors.fill: delegate
            hoverEnabled: true
            onEntered: delegateBackground.color = block.borderColor
            onExited: delegateBackground.color = "transparent"
        }
    }*/
    popup: T.Popup {
        id: popup
